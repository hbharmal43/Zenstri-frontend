...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setError(e.message || 'Authentication failed. Please check your network and GitHub integration.');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <main className="auth-page-container">
      ...
      <div className="glass-panel complex-glass auth-box animate-fade-in">
        ...
        <h2>Welcome back</h2>
        <p className="auth-subtitle">Secure your vibe-coded apps in minutes. Sign in with GitHub to access your workspace dashboard.</p>
        ...
        <div className="auth-footer">
          ...
          <Link href="/signup" className="highlight-orange">Create an account</Link>
        </div>
      </div>
    </main>
  );
